...
@Entity
@Table(name = "MyCircrna")
public class MyCircrna {
    @Id
    private int id;
    private int chr;
    ...
    public MyCircrna(int id, int chr, String startCirc, String endCirc, String geneId, String circId, int junctionFragmentCount, float junctionFPM, float medianCirclen, float fdr) {
        super();
        this.id = id;
        this.chr = chr;
